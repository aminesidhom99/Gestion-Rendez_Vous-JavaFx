...
public class FXMLPostbackController implements Initializable {
      Post p = new Post();
       @FXML
      private FilteredList<Post> filteredStockList;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ServicePost service=new ServicePost();
          ...
          ObservableList<Post> stockList = FXCollections.observableArrayList(service.getall());
filteredStockList = new FilteredList<>(stockList, p -> true);
tftableview.setItems(filteredStockList);
    ...
    filteredStockList.setPredicate(stock -> {
        ...
        if (stock.getHashtagP().toLowerCase().contains(lowerCaseFilter)) {
            return true;
        } else if (String.valueOf(stock.getDescriptionP()).contains(lowerCaseFilter)) {
            return true;
        } 
