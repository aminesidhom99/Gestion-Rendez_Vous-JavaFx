 ...
 * @author amine
 */
public class UpdateForDoctorController implements Initializable {
...
choixcat.getItems().addAll(modes);
 ...
 ServicetypeRDV serviceTypeRDV = new ServicetypeRDV();
        ...
        try {
            ...
            Logger.getLogger(Gui.ChoixBoxController.class.getName()).log(Level.SEVERE, null, ex);
        }
...
try {
                     ...
                     Logger.getLogger(GUI.AffichageTypeController.class.getName()).log(Level.SEVERE, null, ex);
                 }
    ...
    hbox.getChildren().addAll( label1, label3,label4,  label5, label7, iconsBox);  //label1, 
    hbox.setSpacing(20);
